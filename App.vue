...
import { ref, computed, defineAsyncComponent, reactive, watch, markRaw, toRaw } from "vue";
...
// 当前选择游戏的VueComponent
let gameVueComponent = defineAsyncComponent({
...
//   // router.push(`/game/${selectGame.name}`)
// })
</script>
